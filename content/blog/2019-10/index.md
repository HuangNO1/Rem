...
6. 從非 10 進制轉換到 10 進制的演算法，我們使用**指數加權法**：
	...
	![2.png](https://i.loli.net/2019/10/12/gCaNOBKlFHQLTYR.png)

	e.g.

	![3.png](https://i.loli.net/2019/10/12/a4pIUlMhuyXnd1q.png)
...
7. 從 10 進制轉成非 10 進制的演算法，我們使用**餘數乘積法**：
	...
	![4.png](https://i.loli.net/2019/10/12/gemP2szRhtbqQN5.png)

	e.g.

	![5.png](https://i.loli.net/2019/10/12/LnUhtAbpQO6ME1Z.png)
...
![1.png](https://i.loli.net/2019/10/12/Mk8dPmIKag2Ll47.png)
...
![6.png](https://i.loli.net/2019/10/12/mDT1RaHxQUXrzf4.png)
